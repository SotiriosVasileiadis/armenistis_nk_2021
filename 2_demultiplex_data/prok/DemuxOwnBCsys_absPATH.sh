...
echo " "
echo "$(date) : Preparing the lOTUs ready files"
echo " "

mkdir lOTUs_moth_basis

for i in `cat tmp_bclist`
	do
	cat formatch_barcode_${i}_1.fastq revmatch_barcode_${i}_1.fastq >> lOTUs_moth_basis/${i}_lib_R1.fastq
	cat formatch_barcode_${i}_2.fastq revmatch_barcode_${i}_2.fastq >> lOTUs_moth_basis/${i}_lib_R2.fastq
	done
	gzip lOTUs_moth_basis/${i}_lib_R1.fastq
	gzip lOTUs_moth_basis/${i}_lib_R2.fastq
